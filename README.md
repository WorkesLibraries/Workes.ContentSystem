...
Workes.ContentSystem is planned as an engine-neutral backend for storing and organizing extensible content entries.
...
The package is still in foundation design. The intended normal shape is:
...
The exact public API will be finalized during implementation.
